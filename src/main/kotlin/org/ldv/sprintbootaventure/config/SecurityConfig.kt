package org.ldv.sprintbootaventure.config
    ...
    fun filterChain(httpSecurity: HttpSecurity): SecurityFilterChain? {
        return httpSecurity
            ...
            .formLogin { form: FormLoginConfigurer<HttpSecurity?> ->
                form
                    .loginPage("/login").defaultSuccessUrl("/login").failureUrl("/login?error=true")
                    .permitAll()
            }
            ...
            .authorizeHttpRequests { auth ->
                auth
                    ...
                    .requestMatchers("/accueil", "/inscription", "/login", "/css/**", "/js/**", "/img/**", "/favicon.ico").permitAll()
